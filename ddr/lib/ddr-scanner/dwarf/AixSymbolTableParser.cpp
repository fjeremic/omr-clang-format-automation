...
static int parseSymbolTable(const char* line, Dwarf_Error* error)
{
    ...
    if (0 == _startNewFile) {
        ...
        /* Skip lines of the format "debug		0		(b|e)incl" until finding a line of the format "debug	0
         * decl". These first lines in the file list includes before the section listing the type declarations.
         */
