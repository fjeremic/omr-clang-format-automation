...
protected:
	...
	volatile uintptr_t
	        _largestFreeEntry; /**< largest free entry found at the end of a global GC cycle (no meaning during mutator execution) */

	uintptr_t
	        _approximateFreeMemorySize; /**< The approximate number of bytes free that could be made part of the free list */
	...
	MM_LargeObjectAllocateStats*
	        _largeObjectAllocateStats; /**< Approximate allocation profile for large objects. Struct to keep merged stats from all free lists */
...
public:
	...
	virtual MM_HeapLinkedFreeHeader* rebuildFreeListInRegion(MM_EnvironmentBase* env,
	...
	virtual void expandWithRange(MM_EnvironmentBase* env,
	                             ...
	                             bool canCoalesce) = 0;
	virtual void*
	contractWithRange(MM_EnvironmentBase* env, uintptr_t contractSize, void* lowAddress, void* highAddress) = 0;
