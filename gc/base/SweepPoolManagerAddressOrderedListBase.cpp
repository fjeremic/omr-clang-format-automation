 ...
 */
MMINLINE void
MM_SweepPoolManagerAddressOrderedListBase::calculateTrailingDetails(MM_ParallelSweepChunk* sweepChunk,
...
MM_SweepPoolManagerAddressOrderedListBase::connectFinalChunk(MM_EnvironmentBase* envModron, MM_MemoryPool* memoryPool)
{
	...
	if (sweepState->_connectPreviousFreeEntry) {
		...
		sweepState->updateLargestFreeEntry(sweepState->_connectPreviousFreeEntrySize,
		                                   sweepState->_connectPreviousPreviousFreeEntry);
	}
 ...
 */
bool
MM_SweepPoolManagerAddressOrderedListBase::addFreeMemory(MM_EnvironmentBase* env,
                                                         MM_ParallelSweepChunk* sweepChunk,
                                                         uintptr_t* address,
                                                         uintptr_t size)
{
