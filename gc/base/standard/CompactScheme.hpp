...
protected:
	...
	MM_HeapRegionManager*
	        _rootManager; /**< The root region manager which holds the MM_HeapRegionDescriptor instances which manage the properties of the regions */
	...
	SubAreaEntry*
	        _subAreaTable; /**< Reference to the subAreaTable which is shared data from the SweepHeapSectioning */
