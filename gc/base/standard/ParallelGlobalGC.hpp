...
private:
	 ...
	 * @return true if a compaction is required, false otherwise.
	 */
	bool compactRequiredBeforeHeapContraction(MM_EnvironmentBase* env,
	                                          MM_AllocateDescription* allocDescription,
	 ...
	 */
	void
	masterThreadCompact(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription, bool rebuildMarkBits);
#endif /* OMR_GC_MODRON_COMPACTION */
