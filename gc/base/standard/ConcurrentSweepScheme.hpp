...
private:
	...
	omrthread_monitor_t
	        _completeSweepingConcurrentlyLock; /**< Lock to gain access to number of threads completing sweep concurrently */
protected:
...
private:
	...
	getNextSweepChunk(MM_EnvironmentStandard* env, MM_ConcurrentSweepPoolState* sweepPoolState);
	MM_ParallelSweepChunk*
	getPreviousSweepChunk(MM_EnvironmentStandard* env, MM_ConcurrentSweepPoolState* sweepState);
	...
	MM_ParallelSweepChunk*
	getNextConnectChunk(MM_EnvironmentStandard* env, MM_ConcurrentSweepPoolState* sweepPoolState);
	void initializeStateForConnections(MM_EnvironmentBase* envModron,
