...
private:
	 ...
	 */
	MM_HeapLinkedFreeHeader* internalAllocateFromList(MM_EnvironmentBase* env,
	 ...
	 */
	void moveLastFreeEntryToReservedFreeList(MM_EnvironmentBase* env,
...
protected:
	virtual void* internalAllocate(MM_EnvironmentBase* env,
	                               uintptr_t sizeInBytesRequired,
	                               bool lockingRequired,
	                               MM_LargeObjectAllocateStats* largeObjectAllocateStats);
	virtual bool internalAllocateTLH(MM_EnvironmentBase* env,
...
public:
	static MM_MemoryPoolHybrid*
	newInstance(MM_EnvironmentBase* env, uintptr_t minimumFreeEntrySize, uintptr_t maxSplit);
	static MM_MemoryPoolHybrid*
	newInstance(MM_EnvironmentBase* env, uintptr_t minimumFreeEntrySize, uintptr_t maxSplit, const char* name);
	...
	virtual bool removeFreeEntriesWithinRange(MM_EnvironmentBase* env,
	                                          void* lowAddress,
	                                          void* highAddress,
	...
	virtual void expandWithRange(MM_EnvironmentBase* env,
	                             ...
	                             bool canCoalesce);
	virtual void*
	contractWithRange(MM_EnvironmentBase* env, uintptr_t contractSize, void* lowAddress, void* highAddress);
