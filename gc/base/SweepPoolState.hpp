...
public:
	...
	MM_HeapLinkedFreeHeader*
	        _connectPreviousPreviousFreeEntry; /**< previous free entry of the last free entry to be connected into the subspace */
	 ...
	 */
	MMINLINE void updateLargestFreeEntry(UDATA largestFreeEntrySizeCandidate,
