 ...
 */
void*
MM_TLHAllocationInterface::allocateFromTLH(MM_EnvironmentBase* env,
...
void*
MM_TLHAllocationInterface::allocateObject(MM_EnvironmentBase* env,
                                          MM_AllocateDescription* allocDescription,
                                          ...
                                          bool shouldCollectOnFailure)
{
	...
	env->_oolTraceAllocationBytes +=
	        (_stats.bytesAllocated() - _bytesAllocatedBase); /* Increment by bytes allocated */

	return result;
}

void*
MM_TLHAllocationInterface::allocateArray(MM_EnvironmentBase* env,
...
void*
MM_TLHAllocationInterface::allocateArrayletSpine(MM_EnvironmentBase* env,
                                                 MM_AllocateDescription* allocateDescription,
                                                 MM_MemorySpace* memorySpace,
                                                 bool shouldCollectOnFailure)
{
...
void*
MM_TLHAllocationInterface::allocateArrayletLeaf(MM_EnvironmentBase* env,
                                                MM_AllocateDescription* allocateDescription,
                                                MM_MemorySpace* memorySpace,
                                                bool shouldCollectOnFailure)
{
	...
	if ((NULL != cac) && (allocateDescription->getTenuredFlag())) {
		...
		result = memorySpace->getDefaultMemorySubSpace()->allocateArrayletLeaf(env, allocateDescription, NULL,
