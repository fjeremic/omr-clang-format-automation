 ...
 */
uintptr_t
MM_PhysicalSubArenaRegionBased::doContractInSubSpace(MM_EnvironmentBase* env,
...
uintptr_t
MM_PhysicalSubArenaRegionBased::getAvailableContractionSize(MM_EnvironmentBase* env,
