...
MM_MemoryPoolAddressOrderedList::initialize(MM_EnvironmentBase* env)
{
	...
	_largeObjectAllocateStats = MM_LargeObjectAllocateStats::newInstance(
	        env, (uint16_t)ext->largeObjectAllocationProfilingTopK, ext->largeObjectAllocationProfilingThreshold,
...
MMINLINE void
MM_MemoryPoolAddressOrderedList::updateHint(MM_HeapLinkedFreeHeader* oldFreeEntry,
 ...
 */
MMINLINE void*
MM_MemoryPoolAddressOrderedList::internalAllocate(MM_EnvironmentBase* env,
...
MM_MemoryPoolAddressOrderedList::allocateObject(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription)
{
	...
	if (addr != NULL) {
		...
		allocDescription->setNurseryAllocation((_memorySubSpace->getTypeFlags() == MEMORY_TYPE_NEW) ? true
		                                                                                            : false);
...
void*
MM_MemoryPoolAddressOrderedList::collectorAllocate(MM_EnvironmentBase* env,
...
MMINLINE bool
MM_MemoryPoolAddressOrderedList::internalAllocateTLH(MM_EnvironmentBase* env,
...
void*
MM_MemoryPoolAddressOrderedList::allocateTLH(MM_EnvironmentBase* env,
                                             MM_AllocateDescription* allocDescription,
                                             uintptr_t maximumSizeInBytesRequired,
                                             void*& addrBase,
                                             void*& addrTop)
...
MM_MemoryPoolAddressOrderedList::rebuildFreeListInRegion(MM_EnvironmentBase* env,
                                                         ...
                                                         MM_HeapLinkedFreeHeader* previousFreeEntry)
{
	...
	if (createFreeEntry(env, rangeBase, rangeTop, previousFreeEntry, NULL)) {
		...
		TRIGGER_J9HOOK_MM_PRIVATE_REBUILD_FREE_LIST(env->getExtensions()->privateHookInterface,
		                                            env->getOmrVMThread(), rangeBase, rangeTop);
	}
	unlock(env);
...
bool
MM_MemoryPoolAddressOrderedList::removeFreeEntriesWithinRange(MM_EnvironmentBase* env,
                                                              void* lowAddress,
                                                              void* highAddress,
 ...
 */
void*
MM_MemoryPoolAddressOrderedList::findAddressAfterFreeSize(MM_EnvironmentBase* env,
...
bool
MM_MemoryPoolAddressOrderedList::recycleHeapChunk(void* addrBase,
                                                  void* addrTop,
                                                  MM_HeapLinkedFreeHeader* previousFreeEntry,
 ...
 */
uintptr_t
MM_MemoryPoolAddressOrderedList::getAvailableContractionSizeForRangeEndingAt(MM_EnvironmentBase* env,
                                                                             MM_AllocateDescription* allocDescription,
                                                                             void* lowAddr,
                                                                             void* highAddr)
{
