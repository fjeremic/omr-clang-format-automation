...
MM_SegregatedGC::newInstance(MM_EnvironmentBase* env)
{
	...
	globalGC = (MM_SegregatedGC*)env->getForge()->allocate(sizeof(MM_SegregatedGC),
...
{
	return _markingScheme->heapRemoveRange(env, subspace, size, lowAddress, highAddress, lowValidAddress,
	                                       highValidAddress);
}
 ...
 */
bool
MM_SegregatedGC::internalGarbageCollect(MM_EnvironmentBase* env,
                                        MM_MemorySubSpace* subSpace,
