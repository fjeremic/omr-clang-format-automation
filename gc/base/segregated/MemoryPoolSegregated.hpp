...
public:
	...
	static MM_MemoryPoolSegregated* newInstance(MM_EnvironmentBase* env,
	...
	virtual void*
	allocateTLH(MM_EnvironmentBase* env, uintptr_t maxSizeInBytesRequired, void*& addrBase, void*& addrTop);
	...
	virtual void
	expandWithRange(MM_EnvironmentBase* env, uintptr_t expandSize, void* lowAddr, void* highAddr, bool canCoalesce);
...
protected:
	...
	MM_MemoryPoolSegregated(MM_EnvironmentBase* env,
	                        MM_RegionPoolSegregated* regionPool,
	                        uintptr_t minimumFreeEntrySize,
