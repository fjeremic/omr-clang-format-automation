...
void
MM_SegregatedListPopulator::initializeObjectHeapBufferedIteratorState(MM_HeapRegionDescriptor* region,
...
uintptr_t
MM_SegregatedListPopulator::populateObjectHeapBufferedIteratorCache(omrobjectptr_t* cache,
                                                                    uintptr_t count,
                                                                    GC_ObjectHeapBufferedIteratorState* state) const
{
	...
	if (NULL != startPtr) {
		GC_ObjectHeapIteratorSegregated iterator(state->extensions, startPtr, (omrobjectptr_t)state->data2,
		                                         ...
		                                         state->data4, state->includeDeadObjects,
