...
void*
MM_MemorySubSpaceSegregated::allocateObject(MM_EnvironmentBase* env,
 ...
 */
void*
MM_MemorySubSpaceSegregated::allocateArrayletLeaf(MM_EnvironmentBase* env,
                                                  MM_AllocateDescription* allocDescription,
                                                  MM_MemorySubSpace* baseSubSpace,
                                                  MM_MemorySubSpace* previousSubSpace,
                                                  bool shouldCollectOnFailure)
                                                           ...
                                                           AllocateType allocType)
{
	...
	if (NULL != _collector) {
		...
		result = _collector->garbageCollect(env, this, allocDescription, J9MMCONSTANT_IMPLICIT_GC_DEFAULT, NULL,
		                                    NULL, NULL);
		allocDescription->restoreObjects(env);
		result = allocate(env, allocDescription, allocType);
		...
		result = _collector->garbageCollect(env, this, allocDescription, J9MMCONSTANT_IMPLICIT_GC_AGGRESSIVE,
		                                    NULL, NULL, NULL);
		allocDescription->restoreObjects(env);
		result = allocate(env, allocDescription, allocType);
