...
public:
	static MM_MemorySubSpaceSemiSpace* newInstance(MM_EnvironmentBase* env,
	...
	virtual void
	checkResize(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription = NULL, bool systemGC = false);
