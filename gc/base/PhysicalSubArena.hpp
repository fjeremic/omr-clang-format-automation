...
public:
	...
	virtual uintptr_t
	checkCounterBalanceExpand(MM_EnvironmentBase* env, uintptr_t expandSizeDeltaAlignment, uintptr_t expandSize);
	...
	virtual uintptr_t getAvailableContractionSize(MM_EnvironmentBase* env,
