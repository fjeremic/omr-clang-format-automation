...
protected:
	...
	const uintptr_t
	        _requestedSizeInBytes; /**< minimum number of bytes to allocate for object header+instance data */
...
public:
	...
	enum ObjectAllocationFlags
	{
		...
		,
		allocate_indexable =
		        OMR_GC_ALLOCATE_OBJECT_INDEXABLE /**< select this flag to allocate an indexable object */
	};
...
public:
	...
	MM_AllocateInitialization(MM_EnvironmentBase* env,
	        ...
	        : MM_Base(),
	          ...
	          _isAllocatable(true),
	          _allocateDescription(_requestedSizeInBytes,
