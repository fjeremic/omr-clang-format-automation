...
private:
	...
	uintptr_t
	        _bytesAllocatedBase; /**< Bytes allocated at the start of an allocation request.  Relative to _stats.bytesAllocated(). */
...
private:
	...
	void*
	allocateFromTLH(MM_EnvironmentBase* env, MM_AllocateDescription* allocDescription, bool shouldCollectOnFailure);
