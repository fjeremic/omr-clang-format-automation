...
public:
	...
	uintptr_t
	        _arrayletUnknownObjects; /**< Count of non-contiguous arraylets of unknown type (if class is unloaded)*/
	uintptr_t
	...
	uintptr_t
	        _rememberedSetBytesFree; /**< Count of buffers in global free pool (represented in bytes). Buffers in thread local pools are not counted */
	...
	uintptr_t
	        _rememberedSetBeingRebuiltRegionCount; /**< Count of overflowed regions that are being rebuilt currently by GMP */
