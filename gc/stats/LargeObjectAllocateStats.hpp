...
private:
	...
	OMRSpaceSaving*
	        _spaceSavingSizesAveragePercent; /**< Internal top-k-frequent data structure to maintain the stats for exact sizes */
	OMRSpaceSaving*
	        _spaceSavingSizeClassesAveragePercent; /**< Internal top-k-frequent data structure to maintain the stats for size-classes */
	...
	uintptr_t
	        _veryLargeEntrySizeClass; /**< index of sizeClass for minimum veryLargeEntry, the cache value of GCExtensions.largeObjectAllocationProfilingVeryLargeObjectSizeClass */
	...
	MM_FreeEntrySizeClassStats
	        _freeEntrySizeClassStats; /**< global (still per pool) statistics structure for heap free entry size (sizeClass) distribution */
#if defined(OMR_GC_THREAD_LOCAL_HEAP)
	MM_FreeEntrySizeClassStats
	        _tlhAllocSizeClassStats; /**< distribution/historgram of tlh sizes actually allocated */
#endif
	...
	uintptr_t
	        _TLHFrequentAllocationSize; /**< preserved next value of FrequentAllocationSize on last invocation of simulateAllocateTLHs */
...
public:
	...
	static MM_LargeObjectAllocateStats* newInstance(MM_EnvironmentBase* env,
	...
	uintptr_t
	incrementFreeEntrySizeClassStats(uintptr_t freeEntrySize, MM_FreeEntrySizeClassStats* freeEntrySizeClassStats)
	{
