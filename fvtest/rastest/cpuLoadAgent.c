 ...
 *
 * CaseID 	CPUs		userPrivilege 	isSupported		ThreadID 	Sample1 	Sample2 	CurrentSample 	Expected
 *Return Value 1 		multiple 	sufficient 		True 			valid 		valid 		invalid 	valid
 *OMR_ERROR_NONE 2 		multiple 	sufficient 		True 			valid 		valid 		valid 		valid
 *OMR_ERROR_NONE 3 		multiple 	sufficient 		True 			valid 		valid 		valid 		doNotExist
 *OMR_ERROR_NONE 4 		multiple 	sufficient 		True 			valid 		valid 		invalid 	doNotExist
 *OMR_ERROR_RETRY 5 		multiple 	sufficient 		True 			valid 		valid 		doNotExist 	doNotExist
 *OMR_ERROR_RETRY 6 		multiple 	sufficient 		True 			valid 		valid 		invalid 	invalid
 *OMR_ERROR_RETRY 7 		multiple 	sufficient 		True 			valid 		invalid 	valid 		valid
 *OMR_ERROR_NONE 8 		single 		sufficient 		True 			valid 		valid 		valid 		valid
 *OMR_ERROR_NONE 9 		multiple 	insufficient 	True 			valid 		/ 				/ 		doNotExist
 *OMR_ERROR_NOT_AVAILABLE
 *	10 		multiple 	sufficient 		false 			valid 		/ 				/ 		doNotExist
 *OMR_ERROR_NOT_AVAILABLE
 *	11		/				/			/				NULL		/				/		doNotExist
