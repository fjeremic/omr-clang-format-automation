    ...
    void* endAddress, uintptr_t alignmentInBytes, uintptr_t vmemOptions, uintptr_t mode)
{
     ...
     * 			- i.e. SLB(segment lookaside buffer), TLB(table lookaside buffer), and ERAT(effective address to real
     * address table). In particular, each 256MB requires an SLB entry.
     *
     */
