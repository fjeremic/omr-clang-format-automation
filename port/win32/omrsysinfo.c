            ...
            if (ERROR_SUCCESS
                ...
                if (isServerMajorVersion10
                    ...
                    if (sizeof(ridBuffer) >= valueSize) {
                        if (ERROR_SUCCESS
                            == RegQueryValueExA(hKey, RELEASE_ID_KEY, NULL, NULL, (LPBYTE)ridBuffer, &valueSize)) {
                            if (0 == strcmp(ridBuffer, "1607")) {
                                ...
                                if (NULL != productNameBuffer) {
                                    ...
                                    portLibrary->str_printf(portLibrary, productNameBuffer, bufferSize, "%s%s",
                ...
                if (defaultTypeName == PPG_si_osType) {
                    ...
                    if (ERROR_SUCCESS == RegQueryValueExA(hKey, PRODUCT_NAME_KEY, NULL, NULL, NULL, &valueSize)) {
                        ...
                        if (NULL != productNameBuffer) {
                            ...
                            if (ERROR_SUCCESS
                                == RegQueryValueExA(
                                    hKey, PRODUCT_NAME_KEY, NULL, NULL, (LPBYTE)productNameBuffer, &valueSize)) {
